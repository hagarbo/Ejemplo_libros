...
final class Version20240417161358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nota CHANGE created_at fecha_modificion DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nota CHANGE fecha_modificion created_at DATETIME NOT NULL');
    }
}
